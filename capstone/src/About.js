    ...
    <section id="about" className="about-section">
      <div className="about-text">
        ...
        <p>
          ...
          every dish at Little Lemon.
        </p>
        <p>
          Adrian Rossi, Mario's younger brother, leads the marketing and expanded
          the menu beyond classic Italian to include flavors from Greece, Lebanon,
          and Turkey. Together, they created a warm, rustic restaurant where great
          food meets a welcoming atmosphere for everyone.
        </p>
      </div>
